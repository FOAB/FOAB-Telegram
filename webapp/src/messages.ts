...
const catalogs: Readonly<Record<UiLocale, UiMessages>> = {
  'en-US': {
    ...
    welcomeHelp: 'Sent when new members join.',
    ...
    goodbyeHelp: 'Sent when a member leaves.',
    ...
    enable: 'Enable',
    disable: 'Disable',
    messageEditorHelp: 'Use the switch to pause delivery without deleting this text. Saving an empty field removes it.',
    close: 'Close',
    reload: 'Reload',
  ...
  'pt-BR': {
    ...
    welcomeHelp: 'Enviada quando novos membros entram.',
    ...
    goodbyeHelp: 'Enviada quando um membro sai.',
    ...
    enable: 'Ativar',
    disable: 'Desativar',
    messageEditorHelp: 'Use o switch para pausar o envio sem apagar este texto. Salvar o campo vazio remove a mensagem.',
    close: 'Fechar',
    reload: 'Recarregar',
  ...
  'es-ES': {
    ...
    welcomeHelp: 'Se envía cuando entran nuevos miembros.',
    ...
    goodbyeHelp: 'Se envía cuando un miembro sale.',
    ...
    enable: 'Activar',
    disable: 'Desactivar',
    messageEditorHelp: 'Usa el interruptor para pausar el envío sin borrar este texto. Guardar el campo vacío elimina el mensaje.',
    close: 'Cerrar',
    reload: 'Recargar',
