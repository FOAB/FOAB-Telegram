...
- **F-006 — Welcome messages:** in progress. Administrators can configure or clear a bounded welcome message through the Mini App, and FOAB sends it for new members after the group update is observed. Cleanup, placeholders, and live Telegram delivery remain.
- **F-007 — Goodbye messages:** in progress. Administrators can configure or clear a bounded goodbye message through the Mini App, and FOAB sends it when a member leaves an active group. Cleanup, placeholders, and live Telegram delivery remain.
